...
$allowed = ['send.php','invoices.php','compose_api.php','activity.php','index.php','template_edit.php','invoice_template_edit.php','templates.php','invoice_templates.php','invoice_export.php'];
$page = ltrim($path, '/');
