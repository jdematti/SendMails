...
- PurgeRepository/purge.php permiten purgar solo a administradores, en todas las sucursales o por filtro, con antigüedad mínima de 90 días. Vista previa de hasta 100 lotes terminales sin actividad reciente, confirmación vinculada a sesión/usuario, revalidación transaccional y comprobante idempotente en SendMail_Settings (`purge_receipt:<token>`). No afecta bases de origen ni plantillas/bajas/exclusiones.
